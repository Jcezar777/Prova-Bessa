...
function ListPrimeirosColocados() {
    ...
    useEffect(() => {
        fetch(
            "http://localhost:4000/PrimeirosColocados"
        )
...
export default ListPrimeirosColocados;